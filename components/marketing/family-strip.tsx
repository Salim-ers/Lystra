      ...
      {FAMILIES.map((f) => {
        ...
        return (
          <Link
            ...
            className="group flex flex-col items-center gap-2.5 rounded-2xl border border-lystra-champagne/25 bg-white/60 px-3 py-5 text-center transition-all duration-300 hover:-translate-y-0.5 hover:border-lystra-champagne/60 hover:bg-white hover:shadow-soft"
          >
