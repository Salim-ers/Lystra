...
const ADMIN_NAV: NavGroup[] = [
  {
    items: [
      ...
      { href: "/admin#prestataires", label: "Talents", icon: ShieldCheck },
      { href: "/admin#elite", label: "Elite & mise en avant", icon: Gem },
      { href: "/admin#conciergerie", label: "Conciergerie", icon: ConciergeBell },
