...
export const metadata: Metadata = {
  ...
  description:
    "Quelques questions suffisent : nous réunissons pour vous une sélection de talents d'exception adaptés à votre moment — événement, ville, budget, style et plus encore.",
};
      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        <header className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-pretty text-base leading-relaxed text-lystra-gray">
            Quelques questions suffisent. À partir de vos réponses, nous réunissons une sélection
            de talents d'exception pensée pour votre moment.
          </p>
        </header>
